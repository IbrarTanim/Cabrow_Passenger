...
import com.cabrow.cabrowpassenger.activities.UberViewPaymentActivity;
import com.cabrow.cabrowpassenger.adapter.PlacesAutoCompleteAdapter;
import com.cabrow.cabrowpassenger.customui.MyFontPopUpTextView;
import com.cabrow.cabrowpassenger.customui.MyFontTextView;
...
import com.cabrow.cabrowpassenger.parse.HttpRequester;
...
import com.cabrow.cabrowpassenger.utils.LocationHelper;
import com.cabrow.cabrowpassenger.utils.MathUtils;
...
public class UberTripFragment extends UberBaseFragment implements
	...
	private void setUpMap() {
		...
		if (map == null) {
			...
			// .getMap();
			// Rokan map = ((MapView) view.findViewById(R.id.maptrip)).getMap();
